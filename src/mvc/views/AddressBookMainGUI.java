...
public class AddressBookMainGUI {
    ...
    private SearchPanel searchingPanel;
    ...
    public AddressBookMainGUI(String text){
     ...
     //   frame.pack();
       ...
       // frame.setLocationRelativeTo(null);
        ...
        /*searchingPanel=new SearchPanel();
        frame.getContentPane().add(searchingPanel,BorderLayout.CENTER);*/
        /* JList names; 
        ...
        btn_search.setForeground(Color.BLUE);
